// icon:face-smile-beam | Fontawesome https://fontawesome.com/ | Fontawesome
import * as React from "react";

function IconFaceSmileBeam(props) {
  return (
    <svg
      viewBox="0 0 512 512"
      fill="currentColor"
