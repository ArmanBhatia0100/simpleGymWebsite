...
const ProgramCard = ()=>{
    return  <div className="program-card mx-2 card">
    <div
      href="#"
    ...
    >
      ...
      <p class="font-normal text-[#B3B3B3]">
        your goal for cardio exercise should be to feel an increase in
        your breathing and heart rate. The goal for strength workouts is
