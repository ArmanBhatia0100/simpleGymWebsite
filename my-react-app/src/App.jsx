          ...
          <header>
            ...
            <nav className="py-3">
              <div className="flex flex-wrap justify-between items-center mx-auto p-4 max-w-screen-xl">
                <h1 className="font-semibold text-[#E02727] text-[48px] whitespace-nowrap self-center">
                  GYM
                </h1>
                ...
                >
                  <ul className="flex md:flex-row flex-col md:space-x-8 rtl:space-x-reverse border-gray-100 md:border-0 mt-4 md:mt-0 p-4 md:p-0 border rounded-lg font-medium">
                    <li>
                      <a
                        href="#"
                        className="block md:bg-transparent px-3 py-2 md:p-0 rounded text-[#E02727] text-[24px] md:text-[#E02727] md:dark:text-[#E02727]"
                        aria-current="page"
                      >
                        About
                      </a>
                    ...
                    <li>
                      <a
                        href="#"
                        className="block dark:border-gray-700 md:hover:bg-transparent md:dark:hover:bg-transparent hover:bg-gray-100 dark:hover:bg-gray-700 px-3 py-2 md:p-0 rounded text-[24px] text-gray-900 md:hover:text-[#E02727] md:dark:hover:text-[#E02727] dark:hover:text-[#E02727] dark:text-white"
                      >
                        Classes
                      </a>
                    </li>
                    ...
                    <li>
                      <a
                        href="#"
                        className="block dark:border-gray-700 md:hover:bg-transparent md:dark:hover:bg-transparent hover:bg-gray-100 dark:hover:bg-gray-700 px-3 py-2 md:p-0 rounded text-[24px] text-gray-900 md:hover:text-[#E02727] md:dark:hover:text-[#E02727] dark:hover:text-white dark:text-white"
                      >
                        Contact
                      </a>
                    </li>
